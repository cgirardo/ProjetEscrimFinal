 ...
 * @author chris_000
 */
public class AvionsEditerController implements Initializable {
    ...
    /**
     * Sets the aeronef to be edited in the dialog.
     * 
     * @param aeronef
     */
    public void setAeronef(Aeronef avion) {
        this.aeronef = avion;

        libelleField.setText(avion.getLibelleAeronef());
        poidsField.setText(Integer.toString(avion.getPoidsMax()));
        dimPorteField.setText(avion.getDimensionPorte());
        dimCargoField.setText(avion.getDimensionCargo());
        volField.setText(Integer.toString(avion.getVolumeCargo()));
        longPisteField.setText(Integer.toString(avion.getLongueurPisteNecessaire()));
        capPleinField.setText(Integer.toString(avion.getCapacitePlein()));
        capVideField.setText(Integer.toString(avion.getCapaciteVide()));
        vitesseField.setText(Integer.toString(avion.getVitesse()));
        consoField.setText(Double.toString(avion.getConsommation()));
        if(avion.isDisponibilite()) {
            dispoField.setText("oui");
        } else {
            dispoField.setText("non");
        }
    }
